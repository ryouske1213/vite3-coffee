...
<template>
  <div class="bg-home min-h-screen h-screen overflow-hidde">
    <!-- <img
    ...
    <div class="relative top-0 h-full">
      <header_1 class="bg-home text-black fixed w-full z-50" />
      <carouse class="pt-24" />
      <main>
      ...
      <div class="w-full flex">
        <div class="w-full flex text-xl font-bold justify-center">
          <p>飲品咖啡</p>
        </div>
        <div class="w-full flex text-xl font-bold justify-center">
          <p>西餐飲食</p>
